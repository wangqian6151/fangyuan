...
from fangyuan.items import AnjukeShoprentalItem


class AnjukeshoprentalSpider(scrapy.Spider):
    name = 'anjukeshoprental'
    allowed_domains = ['sz.sp.anjuke.com']
    start_urls = ['https://sz.sp.anjuke.com/zu/']

    custom_settings = {
        'LOG_FILE': 'log_anjukeshoprental.txt',
    }
    ...
    def parse_list(self, response):
        ...
        for i in li:
            ...
            item['price'] = i.css('em::text').extract_first() + i.css('.price-a::text').extract()[1].strip()
