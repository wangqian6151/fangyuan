...
from fangyuan.items import FangtianxiaShoprentalItem


class FangtianxiashoprentalSpider(scrapy.Spider):
    name = 'fangtianxiashoprental'
    allowed_domains = ['sz.shop.fang.com']
    start_urls = ['http://sz.shop.fang.com/zu/house/']

    custom_settings = {
        'LOG_FILE': 'log_fangtianxiashoprental.txt',
    }
    ...
    def parse_list(self, response):
        ...
        item = FangtianxiaShoprentalItem()
