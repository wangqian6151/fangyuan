...
from fangyuan.items import TongchengShoprentalItem


class TongchengshoprentalSpider(scrapy.Spider):
    name = 'tongchengshoprental'
    allowed_domains = ['sz.58.com']
    start_urls = ['http://sz.58.com/shangpucz/']

    custom_settings = {
        'LOG_FILE': 'log_tongchengshoprental.txt',
    }
    ...
    def parse_list(self, response):
        ...
        for i in li:
            ...
            item['url'] = 'http://sz.58.com/shangpu/' + item['number'] + 'x.shtml'
